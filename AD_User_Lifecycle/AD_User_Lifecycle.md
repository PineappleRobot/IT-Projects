...
![Staff OU with Sales, Accounting and HR](OU-Sales.png)
...
![New User Details](OU-Staff-User.png)
![New User Password Settings](OU-Staff-User-Password.png)
![User Created in Sales OU](OU-Sales-Users.png)
...
![Sales Team and Sales Share groups](John-Member.of.png)
![John Smith added to Sales Team](John-Member.of.png)
![Sales Team nested inside Sales Share](Sales.Share.members.png)
...
![Password Reset Dialog](Password.reset.png)
...
![Account Disabled Confirmation](Account.Disabled.png)